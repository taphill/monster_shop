...
RSpec.describe "merchant/edit", type: :feature do
  describe 'As an admin' do
    context "After visiting a merchants show page and clicking on updating that merchant" do
      before(:each) do
